    ...
    [ { content =
            \_ ->
                Html.div
                    ...
                    , Html.div [ Attr.css [ Css.width <| Css.rem 27 ] ]
                        [ Html.h1 [ Attr.css [ Css.fontSize <| Css.rem 4, Css.lineHeight <| Css.num 1 ] ] [ Html.text "Jeu du Morpion" ]
                        , Html.h2 [ Attr.css [ Css.fontSize <| Css.rem 2, Css.marginTop <| Css.rem 1 ] ] [ Html.text "Elm + TDD" ]
                        ]
                    ]
